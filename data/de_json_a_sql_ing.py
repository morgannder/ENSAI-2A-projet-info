...
def json_to_ingredients(json_file_path, sql_output_path):
    ...
    with open(sql_output_path, 'w', encoding='utf-8') as sql_file:
        ...
        for ingredient_data in data["drinks"]:
            ...
            ingredient_values.append(f"({id_ingredient}, '{nom_ingredient}', '{desc_ingredient}')")
        
        # Écrire l'INSERT bulk
        if ingredient_values:
            sql_file.write("INSERT INTO ingredient (id_ingredient, nom_ingredient, desc_ingredient) VALUES\n")
...
if __name__ == "__main__":
    json_file_path = "extractAPI/all_ingredients_consolidated.json"  # Votre fichier JSON
