...
api_router.include_router(utilisateurs.router, prefix="/mon_compte", tags=["Utilisateur"])
...
api_router.include_router(commentaire.router, prefix="/commentaires", tags=["Commentaires"])
